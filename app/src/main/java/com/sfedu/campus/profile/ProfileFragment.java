...
public class ProfileFragment extends Fragment {
    ...
    public User getUser() {
        ...
        final User[] retUser = new User[1];
        ApiClient.getInstance().getUser(requireView(), context, new ApiClient.ApiCallback<User>() {
            @Override
            public void onSuccess(User data) {
//                token_label.setText(data.getFullName());
                retUser[0] = data;
            }
            @Override
            public void onFailure(String errorMessage) {
                ViewUtils.toast(requireView(), context, errorMessage);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        logout_btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                prefs.clear();
                ViewUtils.toast(view, context, prefs.getJesusSaying());
